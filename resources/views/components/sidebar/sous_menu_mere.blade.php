<div class="lead">
    <i class="bi bi-menu-app"> Menu </i>
                ...
                @if (empty($objet_maternite->maternite_grossesse_a_terme))
                    <div class="content-cell">
                ...
                @else
                    @if (count($maternite_accouchement->get_maternite_from_accouchement)==0)
                        <div class="content-cell">
                    ...
                    @else
                    <div class="content-cell">
                        <label for="accouchement"><span class="bi bi-plus-circle"></span> Cas des jumeaux ou bebe siamois</label>
                        <div class="dropdown d-inline">
                            <button href="#" id="accouchement" class="btn btn-link btn-sm dropdown-toggle" type="button" id="dorpper1" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="bi bi-info-square"></span></button>
                                <ul class="dropdown-menu" aria-label="dorpper1">
                                <li><button href="button" class="btn btn-link dropdown-item" data-bs-target="#add_jumeaux_bebe_siamois" data-bs-toggle="modal">Ajouter</button></li>
                                </ul>
                            </div>
                    </div>
                    @endif
                ...
                <fieldset>
                    ...
                    @empty(!$objet_mere)
                        @foreach ($objet_mere as $get_maternite_from_accouchement=>$item_objet_mere)
                            <div class="mt-2">
