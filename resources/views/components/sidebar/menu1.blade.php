<li class="nav-item">
    ...
    <ul id="menu1" class="nav-content collapse" data-bs-parent="#sidebar-nav1">
        <li><a class="nav-link collapsed" href="{{ route('view_cpn')}}">
    ...
    <ul id="menu2" class="nav-content collapse" data-bs-parent="#sidebar-nav6">
        <li><a class="nav-link collapsed" href="{{ route('view_type_acouchement')}}">
    ...
    <ul id="menu3" class="nav-content collapse" data-bs-parent="#sidebar-nav9">
