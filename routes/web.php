...
Route::group(['namespace' => 'App\Http\Controllers'], function()
{
    ...
    Route::get('view_acc/{id}', 'AccouchementController@viewacouchementself')->name("view_ac");
    Route::get('add_ac/{id}', 'AccouchementController@addacouchementself')->name("add_acc");
